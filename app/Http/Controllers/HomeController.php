...
class HomeController extends Controller
{
    ...
    {
        $data = \App\Customer::selectRaw('name, YEAR(shipping_purchase_date) as year, MONTH(shipping_purchase_date) as month, sum(shipping_order_count) as total')->whereStore(request('store'))->groupBy('name', 'year', 'month')->orderBy('year', 'ASC')->orderBy('month', 'ASC')->get();
